...
jstring Java_com_googlecode_tesseract_android_TessBaseAPI_nativeGetUTF8Text(JNIEnv *env,
  ...
  //char *text = nat->api.GetUTF8Text(&monitor); // Original
  char *text = nat->api.GetUTF8Text(); // cb4960: param removed in v3.5
...
jstring Java_com_googlecode_tesseract_android_TessBaseAPI_nativeGetHOCRText(JNIEnv *env,
  ...
  //char *text = nat->api.GetHOCRText(page, &monitor); // Original
  char *text = nat->api.GetHOCRText(page); // cb4960: param removed in v3.5
