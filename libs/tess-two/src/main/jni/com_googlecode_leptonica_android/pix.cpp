...
/* cb4960 */
jlong Java_com_googlecode_leptonica_android_Pix_nativePixAddBlackOrWhiteBorder(JNIEnv *env, jclass clazz,
																				jlong nativePix,
																				jint left,
																				jint right,
																				jint top,
  ...
  PIX *pixs = (PIX *) nativePix;
  PIX *pixd;
  pixd = pixAddBlackOrWhiteBorder(pixs,(int)left,(int)right,(int)top,(int)bot,(int)op);
  return (jlong) pixd;
}

/* cb4960 */
jfloat Java_com_googlecode_leptonica_android_Pix_nativePixAverageInRect(JNIEnv *env, jclass clazz,
																				jlong nativePix,
																				jint x,
																				jint y,
																				jint w,
  ...
  BOX box = { x, y, w, h };
  jfloat ave = 0.0f;
  jint status = pixAverageInRect(pixs,&box,&ave);
