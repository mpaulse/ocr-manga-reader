...
public class DBOpenHelper extends SQLiteOpenHelper
{
  ...
  private static final String FILES_TABLE_CREATE = "CREATE TABLE " + FILES_TABLE + " ( " + "id INTEGER PRIMARY KEY, "
      + PATH_COLUMN + " TEXT NOT NULL, " + BOOKMARK_COLUMN + " INTEGER NOT NULL, " + READ_COLUMN
      + " BOOLEAN NOT NULL, " + OPENED_COLUMN + " DATE NOT NULL," + VIEWS_COLUMN + " INTEGER NOT NULL, "
